    ...
    if (isset($_FILES['image'])) {
        ...
        if (in_array($imageType, $allowedTypes)) {
            ...
            if (move_uploaded_file($image['tmp_name'], $imagePath)) {
                ...
                echo "<p>Redirigiendo al formulario en 5 segundos...</p>";
                header("refresh:5;url=index.php");
            } else {
                echo "Error al mover el archivo.";
            }
        } else {
            echo "El archivo subido no es una imagen. <a href='index.php'>Intenta de nuevo</a>";
        }
    } else {
        echo "No se ha seleccionado ningún archivo. <a href='index.php'>Intenta de nuevo</a>";
    }
} else {
